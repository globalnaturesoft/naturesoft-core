...
module Naturesoft::Backend
  class NsmodulesController < Naturesoft::Backend::BackendController
    ...
    def create
      ...
      if @nsmodule.save
        redirect_to naturesoft.edit_backend_nsmodule_path(@nsmodule.id), notice: 'Nsmodule was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      ...
      if @nsmodule.update(nsmodule_params)
        redirect_to naturesoft.edit_backend_nsmodule_path(@nsmodule.id), notice: 'Nsmodule was successfully updated.'
      else
        render :edit
      end
    end
