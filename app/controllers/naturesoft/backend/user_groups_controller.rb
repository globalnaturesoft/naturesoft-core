module Naturesoft
  module Backend
    class UserGroupsController < Naturesoft::Backend::BackendController
      ...
      def default_breadcrumb
        ...
        add_breadcrumb "User Groups", naturesoft.backend_user_groups_path
      end
      ...
      def create
        ...
        if @user_group.save
          redirect_to edit_backend_user_group_path(@user_group.id), notice: 'User group was successfully created.'
        else
          render :new
        end
      end
      ...
      def update
        if @user_group.update(user_group_params)
          redirect_to edit_backend_user_group_path(@user_group.id), notice: 'User group was successfully updated.'
        else
          render :edit
        end
      end
